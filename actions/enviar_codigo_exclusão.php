...
try {
    ...
    $mail->SMTPAuth   = true;
    $mail->Username   = 'felippefardin@gmail.com';      // Seu e-mail Gmail aqui
    $mail->Password   = 'ejlg wslz aulp zzgw';          // Senha de app do Gmail (não sua senha normal)
    $mail->SMTPSecure = 'tls';
    $mail->Port       = 587;
...
<form method="POST" action="validar_codigo_exclusao.php">
