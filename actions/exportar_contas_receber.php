...
$fileName = "relatorio_contas_a_receber_" . $status . "_" . date('Y-m-d');
...
$headers = ($status === 'baixada')
    ? ['Responsável', 'Número', 'Valor', 'Vencimento', 'Data Baixa', 'Usuário Baixou']
    : ['Responsável', 'Número', 'Valor', 'Vencimento'];
