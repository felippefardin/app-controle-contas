...
// CORREÇÃO: Verifica se o usuário existe e se o status permite reativação
// Adicionado 'cancelado' e 'inativo' para maior compatibilidade
...
if ($user) {
    ...
    // Mensagem genérica por segurança (ou específica se preferir debug)
    $_SESSION['erro'] = "E-mail não encontrado ou a conta não está elegível para reativação.";
}
