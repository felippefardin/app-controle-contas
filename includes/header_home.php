...
.btn-feedback { background-color: #ffc107 !important; color: #000 !important; }
...
<body>
  <header class="header-controls">
    ...
    <div class="header-group">
        ...
        ?>
            <button type="button" class="btn btn-feedback btn-header" data-bs-toggle="modal" data-bs-target="#modalFeedbackHeader" title="Deixe seu feedback">
...
<?php 
// --- MODAL DE FEEDBACK (APENAS NA HOME) ---
if (basename($_SERVER['PHP_SELF']) === 'home.php'): 
?>
...
<script>
    // Script para o Modal de Feedback (Lógica de envio)
