...
if ($perfil !== 'admin') {
    ...
    // CORREÇÃO: A subconsulta deve incluir o próprio usuário principal
...
if ($result && $result->num_rows > 0) {
    ...
    echo "<thead><tr><th>Responsável</th><th>Vencimento</th><th>Número</th><th>Valor</th><th>Juros</th><th>Forma de Pagamento</th><th>Data de Baixa</th><th>Usuário</th><th>Ações</th></tr></thead>";
    echo "<tbody>";
