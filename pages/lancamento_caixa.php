...
@media (max-width: 768px) {
    ...
    .form-control, .form-control-date { font-size: 0.95rem; padding: 8px; }
    .btn-primary, .btn-pdf { width: 100%; margin-bottom: 10px; font-size: 1rem; }
    table th, table td { padding: 8px; font-size: 0.9rem; }
    .btn-edit, .btn-delete { padding: 4px 8px; font-size: 0.8rem; }
}
</style>
...
function filterTable() {
    ...
    Array.from(table.rows).forEach(row => {
        const dateStr = row.cells[0].innerText.split('/'); // dd/mm/yyyy
